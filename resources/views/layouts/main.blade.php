...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('plugin/vendor/fonts/boxicons.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset ('plugin/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset ('plugin/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset ('plugin/css/demo.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset ('plugin/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />

    <link rel="stylesheet" href="{{ asset ('plugin/vendor/libs/apex-charts/apex-charts.css') }}" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="{{ asset ('plugin/vendor/js/helpers.js') }}"></script>
...
<!-- Core JS -->
    <!-- build:js plugin/vendor/js/core.js -->
    <script src="{{ asset ('plugin/vendor/libs/jquery/jquery.js') }}"></script>
    ...
    <!-- Page JS -->
    <script src="{{ asset ('plugin/js/dashboards-analytics.js') }}"></script>
