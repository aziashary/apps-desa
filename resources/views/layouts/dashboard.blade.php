...
@endforeach
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1><span>Desa Cimanggu I</span></h1>
      <h2>Masyarakat Unggul Sejahtera</h2>
      <div class="d-flex">
  ...
  <main id="main">
    ...
    <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Tentang Kami</h2>
          <h3>Tentang Desa<span> Cimanggu I<span>.</span></span></h3>
        </div>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Dokumentasi</h2>
          <h3>Galeri Desa <span>Cimanggu I</span></h3>
        </div>
    ...
    {{-- <section id="Aparaturdesa" class="team ">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Aparatur Desa</h2>
          <h3>Perangkat Desa <span>Cimanggu I</span></h3>
        </div>
    ...
    <section id="struktur" class="team">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h3>Struktur Organisasi Desa <span>Cimanggu I</span></h3>
        </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6 ">
          <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=kantor desa Cimanggu I&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://piratebay-proxys.com/">Piratebay</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:400px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:400px;}.gmap_iframe {height:400px!important;}</style></div>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Cimanggu I</span></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
